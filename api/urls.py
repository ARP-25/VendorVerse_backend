...
urlpatterns = [
    ...
    path('vendor/create-product/', vendor_views.ProductCreateAPIView.as_view(), name='vendor-shop-product'),
    path('vendor/product/update/<vendor_id>/<product_pid>/', vendor_views.ProductUpdateAPIView.as_view(), name='vendor-shop-product-update'),
    path('vendor/product/delete/<vendor_id>/<product_pid>/', vendor_views.ProductDeleteAPIView.as_view(), name='vendor-shop-product-delete'),
